...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="◼️HELPS AND COMMANDS❔",callback_data="help_back"),
                 InlineKeyboardButton(text="SWIFT STUDY OWNER💚",url="https://t.me/parv_of_sky")]]
    keyboard += [[InlineKeyboardButton(text="🇮🇳UNT EDUCATION",url="https://t.me/UNT_EDUCATION"),
                 InlineKeyboardButton(text="✳️SWIFT STUDY✳️",url="https://t.me/swift_study")]]
    keyboard += [[InlineKeyboardButton(text="♦️SUPPORT GROUP",url="https://t.me/JEE_NEET_DELIGHTS")]]
    keyboard += [[InlineKeyboardButton(text="🔲 CONNCET ME TO YOUR GROUP🔲", url="http://t.me/Swiftstudy_bot?startgroup=true"),
                 InlineKeyboardButton(text="DEMANDS",url="https://t.me/MTGCONNCECTBOT")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/PARV_OF_SKY")]]))
        return
